...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_V),     LCTL(KC_C),     LCTL(KC_X),     KC_TRANSPARENT,                                 LCTL(KC_Z),     KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [3] = LAYOUT_voyager(
    KC_TRANSPARENT, ST_MACRO_0,     KC_QUES,        RALT(KC_8),     RALT(KC_9),     ST_MACRO_1,                                     KC_TRANSPARENT, RCTL(KC_X),     RCTL(KC_C),     RCTL(KC_V),     KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, ST_MACRO_3,     LCTL(KC_V),     LCTL(KC_C),     LCTL(KC_X),     ST_MACRO_4,                                     LSFT(KC_1),     KC_NUBS,        LSFT(KC_NUBS),  LSFT(KC_0),     LSFT(KC_6),     RALT(KC_Q),
  ...
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_KP_PLUS,      KC_4,           KC_5,           KC_6,           KC_KP_DOT,                                    KC_TRANSPARENT, RCTL(KC_X),     RCTL(KC_C),     RCTL(KC_V),     KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [6] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_F11,         KC_F4,          KC_F5,          KC_F6,          KC_PSCR,                                        KC_TRANSPARENT, RCTL(KC_X),     RCTL(KC_C),     RCTL(KC_V),     KC_TRANSPARENT, KC_TRANSPARENT,
