...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_ESCAPE,      KC_Q,       KC_K,           KC_U,           KC_A,           KC_COMMA,                                           KC_P,           KC_C,           KC_M,           KC_L,           KC_F,           KC_MINUS,
    CW_TOGG,        MT(MOD_LGUI, KC_SCLN),         MT(MOD_LALT, KC_H), MT(MOD_LSFT, KC_I), MT(MOD_LCTL, KC_E),           KC_O,                                           KC_D,           MT(MOD_RCTL, KC_T), MT(MOD_RSFT, KC_N), MT(MOD_LALT, KC_R), KC_S, KC_X,
    MT(MOD_LGUI, KC_SLASH),KC_TRANSPARENT, KC_Z,           KC_LBRC,        KC_QUOTE,       KC_DOT,                                        KC_B,           KC_G,           KC_V,           KC_Y,           KC_W,           KC_J,
    KC_TRANSPARENT, KC_7,           KC_5,           KC_3,           LT(4, KC_BSPC), KC_LEFT_SHIFT,                                    LT(5, KC_SPACE),LT(3, KC_DELETE), KC_EQL,           LSFT(KC_EQL),           KC_GRV,           KC_8,
